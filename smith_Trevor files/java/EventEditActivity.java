...
*/
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Event newEvent = new Event(id, eventName, CalendarUtility.selectedDate, time, currentCalendarId);
    ...
    private void initWidgets(){
        ...
        String eventName = String.valueOf(eventNameET.getText());
        String eventTime = String.valueOf(eventTimeET.getText());
    ...
    private void checkForEditEvent(){
        ...
        if(selectedEvent != null){
            eventNameET.setText(selectedEvent.getEventName());
            String formattedTime = CalendarUtility.formattedShortTime(selectedEvent.getTime());
            eventTimeET.setText(formattedTime);
        }
    }
